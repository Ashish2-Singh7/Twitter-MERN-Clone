...
const Message = ({ messageType, msgElement, message, recieverUser, senderUser }) => {
    ...
    return (
        <div className={`chat ${chatClassName}`}>
            ...
            <div className={`chat-bubble ${messageType === "ai" ? "max-w-[450px]" : "max-w-[300px]"} text-white ${bubbleBgColor}`}>
