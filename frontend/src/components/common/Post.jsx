...
const Post = ({ post }) => {
    ...
    const { mutate: likePost, isPending: isLiking } = useMutation({
        ...
        onSuccess: (updatedLikes) => {
            // this is not the best user experience because it will refetch all posts;
            // queryClient.invalidateQueries({ queryKey: ["posts"] });

            // not invalidating or fetching the posts again. Rather updating the cache for that post directly;
