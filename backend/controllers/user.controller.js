...
export const getSuggestedUsers = async (req, res) => {
    try {
        ...
        const usersToFollowedByMe = await User.findById(userId).select("-password");
        ...
        const filteredUsers = users.filter(user => !usersToFollowedByMe.following.includes(user._id));
